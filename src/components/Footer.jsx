  ...
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      <div>
        ...
        <p className='py-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga quo delectus cumque suscipit quia nesciunt temporibus voluptatibus aliquid, voluptas velit obcaecati ratione nihil beatae eius blanditiis. Consequuntur delectus assumenda iure.</p>
      ...
      <div className='lg:col-span-2 flex justify-between'>
        <div>
          ...
          <ul>
            ...
            <li className='py-2 text-sm cursor-pointer'>Insigths</li>
          </ul>
        </div>
        <div>
